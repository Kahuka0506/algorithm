# lazy_segment_tree_RSQ_RAQ
リンク : [../data_structure/lazy_segment_tree_RSQ_RAQ.cpp](../data_structure/lazy_segment_tree_RSQ_RAQ.cpp)    
最終更新 : 2022-11-11 00:33:53.732900
...
auto op_nl = [](pll a, ll b){return make_pair(a.fi+b*a.se,a.se);};
//ve<pll> a(N,make_pair(0LL,1LL));
